...
class DatabaseInstance(messages.Message):
  ...
  Fields:
    ...
    region: The geographical region. Can be us-east1, us-central, asia-east1
      or europe-west1. Defaults to us-central. The region can not be changed
      after instance creation.
  ...
  kind = messages.StringField(7, default=u'sql#instance')
  masterInstanceName = messages.StringField(8)
  maxDiskSize = messages.IntegerField(9)
  project = messages.StringField(10)
  region = messages.StringField(11)
  replicaNames = messages.StringField(12, repeated=True)
  serverCaCert = messages.MessageField('SslCert', 13)
  settings = messages.MessageField('Settings', 14)
  state = messages.StringField(15)
...
class IpConfiguration(messages.Message):
  ...
  enabled = messages.BooleanField(2)
  requireSsl = messages.BooleanField(3)
