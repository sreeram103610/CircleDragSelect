...
class AddPathMatcher(base_classes.ReadWriteCommand):
  ...
  def Modify(self, args, existing):
    ...
    if new_hosts:
      ...
      replacement.hostRules.append(messages.HostRule(
    ...
    'EXAMPLES': """\
        ...
        ``google.com'' and ``*.google.com'', run:
          ...
          $ {command} my-url-map \\
              ...
              --path-rules /search=search-service \\
