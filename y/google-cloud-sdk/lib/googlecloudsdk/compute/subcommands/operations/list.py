...
class List(base_classes.BaseLister):
  ...
  def global_service(self):
    return self.context['compute'].globalOperations

  @property
  def regional_service(self):
    return self.context['compute'].regionOperations

  @property
  def zonal_service(self):
    return self.context['compute'].zoneOperations
  ...
  def GetResources(self, args, errors):
    ...
    if no_scope_flags:
      ...
      region_names = args_region_names or self.FetchChoices(
          attribute='region',
          service=self.context['compute'].regions,
          flag_name='--regions')
      ...
      zone_names = args_zone_names or self.FetchChoices(
          attribute='zone',
          service=self.context['compute'].zones,
          flag_name='--zones')
