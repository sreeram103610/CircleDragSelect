...
DEPRECATION_STATUSES = sorted(
    ['ACTIVE'] +
    messages.DeprecationStatus.StateValueValuesEnum.to_dict().keys())
...
class DeprecateImages(base_classes.NoOutputAsyncMutator):
  ...
  def CreateRequests(self, args):
    ...
    if args.state == 'ACTIVE':
      ...
      state = messages.DeprecationStatus.StateValueValuesEnum(args.state)
    ...
    request = messages.ComputeImagesDeprecateRequest(
