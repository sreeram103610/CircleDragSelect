...
class Patch(base.Command):
  ...
  def SetDatabaseReplicationSettings(self, settings,
                                     enable_database_replication,
                                     no_enable_database_replication):
  ...
  def Run(self, args):
    ...
    enable_database_replication = args.enable_database_replication
    no_enable_database_replication = args.no_enable_database_replication
    ...
    if enable_database_replication and no_enable_database_replication:
      raise exceptions.ToolException('Argument --enable-database-exception not '
                                     'allowed with '
                                     '--no-enable-database-replication')
    settings = {}
    if tier:
    ...
    self.SetDatabaseReplicationSettings(settings, enable_database_replication,
                                        no_enable_database_replication)
