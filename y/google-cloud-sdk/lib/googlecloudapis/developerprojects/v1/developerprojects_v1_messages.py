...
class DeleteProjectRequest(messages.Message):
  """The request sent to the DeleteProject(...) method.
...
class DeveloperprojectsDeveloperProjectsDeleteprojectResponse(messages.Message):
  """An empty DeveloperprojectsDeveloperProjectsDeleteproject response."""


class DeveloperprojectsDeveloperProjectsUndeleteprojectResponse(messages.Message):
  """An empty DeveloperprojectsDeveloperProjectsUndeleteproject response."""
...
class UndeleteProjectRequest(messages.Message):
