...
class DeveloperprojectsV1(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    self.developerProjects = self.DeveloperProjectsService(self)
    self.projects = self.ProjectsService(self)

  class DeveloperProjectsService(base_api.BaseApiService):
    """Service class for the developerProjects resource."""

    _NAME = u'developerProjects'

    def __init__(self, client):
      super(DeveloperprojectsV1.DeveloperProjectsService, self).__init__(client)
      self._method_configs = {
          'Deleteproject': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'developerprojects.developerProjects.deleteproject',
              ordered_params=[],
              path_params=[],
              query_params=[],
              relative_path=u'developerProjects/deleteproject',
              request_field='<request>',
              request_type_name=u'DeleteProjectRequest',
              response_type_name=u'DeveloperprojectsDeveloperProjectsDeleteprojectResponse',
              supports_download=False,
          ),
          'Undeleteproject': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'developerprojects.developerProjects.undeleteproject',
              ordered_params=[],
              path_params=[],
              query_params=[],
              relative_path=u'developerProjects/undeleteproject',
              request_field='<request>',
              request_type_name=u'UndeleteProjectRequest',
              response_type_name=u'DeveloperprojectsDeveloperProjectsUndeleteprojectResponse',
              supports_download=False,
          ),
          }
    ...
    def Deleteproject(self, request, global_params=None):
      """Deleteproject method for the developerProjects service.

      Args:
        request: (DeleteProjectRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (DeveloperprojectsDeveloperProjectsDeleteprojectResponse) The response message.
      """
      config = self.GetMethodConfig('Deleteproject')
      return self._RunMethod(
          config, request, global_params=global_params)

    def Undeleteproject(self, request, global_params=None):
      """Undeleteproject method for the developerProjects service.

      Args:
        request: (UndeleteProjectRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (DeveloperprojectsDeveloperProjectsUndeleteprojectResponse) The response message.
      """
      config = self.GetMethodConfig('Undeleteproject')
      return self._RunMethod(
          config, request, global_params=global_params)
